<template>
  ...
  <p>
    PKU Tools is an independent project run by André Reus, who is the controller under the GDPR.
    This policy covers the website and the app, which work the same way and store your data in the
    same place.
  </p>
  <p>The operator can be reached by email at <LegalContactEmail />.</p>
  ...
  <p>
    Your diary, blood values and targets say something about your health, so the GDPR treats them as
    a special category of data. That is why the app asks for explicit consent before storing any of
    it, and why the health features stay switched off until you give it.
  </p>
  <p>
    You can withdraw that consent at any time in Settings. Withdrawing stops new health data being
    saved and makes those features unavailable. It does not delete what is already stored — you can
    do that separately in Settings. Withdrawing also does not undo processing that was lawful
    before.
  </p>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>The barcode you scanned, and your IP address.</td>
          <td>Only when you scan a barcode</td>
        </tr>
        <tr>
          <td>
            <strong>PostHog</strong> (EU servers)
            <br />
          ...
          <td>
            Which pages you open, your IP address, and session replays, which can include content
            shown on the page.
          </td>
          <td>Every visit</td>
        </tr>
        <tr>
          ...
          <td>Page views, without cookies.</td>
          <td>Every visit</td>
        </tr>
        <tr>
          <td>
          ...
          <td>Whatever Google collects when you install or update the app.</td>
          <td>Only if you install from Google Play</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <p>
    PKU Tools stores a few things in your browser to keep you signed in and to remember choices such
    as appearance, camera and your analytics decision. None of those are used to track you.
  </p>
  <p>
    ...
    changes nothing about how the app works for you, and you can change your mind later by clearing
  ...
  <p>
    ...
    or email. After you delete your account it no longer points to a live account, though temporary
    copies can remain in backups or provider logs for the periods described below.
  </p>
  <p>
  ...
  <p>
    Your data is kept for as long as your account exists. When you delete your account, your data
  ...
  <ul>
    <li>ask what data is stored about you, and get a copy of it</li>
  ...
  <p>
    Account deletion and health data consent withdrawal are built into Settings, so you do not have
    to ask. For anything else, contact the operator by email.
  </p>
  <p>
    You also have the right to lodge a complaint with a data protection authority. The competent
    authority for PKU Tools is the Landesbeauftragte für den Datenschutz und die
    Informationsfreiheit Baden-Württemberg, and you can equally go to the authority where you live.
  </p>
  ...
  <h2>Children</h2>
  <p>
    Account holders need to be at least 18. A parent or legal guardian can use their own account to
    manage a child's PKU diet if they are legally allowed to provide the child's health information.
    The health information in that account may therefore be about the child.
  </p>

  <h2>Security</h2>
  <p>
    Data is transmitted over encrypted connections, and each account can only reach its own data and
    what has been shared with the community. No online service can promise absolute security.
  </p>
  ...
  <h2>Questions</h2>
  <p>Questions can be sent by email to <LegalContactEmail />.</p>
</template>
