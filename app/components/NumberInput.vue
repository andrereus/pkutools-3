<script setup>
defineProps(['idName', 'label', 'placeholder'])
...
<template>
  <div>
    ...
    >
    <div class="mt-1 mb-3">
      <!-- step="any" so decimals count as valid input: weights, references and
           nutrients are all stored at the precision they were entered, and the
           default step of 1 would mark anything fractional as invalid -->
      <input
        :id="idName"
