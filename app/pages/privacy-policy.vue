...
<template>
  <div class="prose dark:prose-invert">
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to PKU Tools, the software program provided by the
          Company.
        </p>
      </li>
      <li>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PKU Tools.
        </p>
    ...
    <ul>
      <li>
        <strong>Consent:</strong> You have given Your consent for processing Personal Data for one
    ...
    <ul>
      ...
      <li>
        <strong>Request correction of the Personal Data that We hold about You.</strong> You have
