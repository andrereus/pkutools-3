...
<template>
  <div class="prose dark:prose-invert">
    ...
    <p>
      The Company makes no guarantee or warranty with respect to any products or services sold. The
    ...
    <p>
      Use of the advice and information contained herein is at your sole choice and risk. You should
      ...
      beginning any nutrition or exercise program.
    </p>
    <p>
    ...
    <p>
      ...
      as provided for in section 107 of the United States Copyright law.
    </p>
    <p>
    ...
    <p>
      ...
      As such, it should not be used as a substitute for consultation with professional accounting,
    ...
    <p>
      ...
      information, and without warranty of any kind, express or implied, including, but not limited
    ...
    <ul>
      <!-- prettier-ignore -->
      <li>By email: {{ part1 }}@<span class="hidden">null</span>{{ part2 }}.{{ part3 }}</li>
    </ul>
  </div>
</template>
